"""
Django settings for firstlocalapp_1 project.
...
ROOT_URLCONF = 'firstlocalapp_1.urls'
...
WSGI_APPLICATION = 'firstlocalapp_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "firstlocalapp_1 API",
    "DESCRIPTION": "API documentation for firstlocalapp_1 App",
    "VERSION": "v1",
}
